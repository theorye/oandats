...
// Market Orders can be specialized when they are created to accomplish a specific task:
// to close a Trade, to closeout a Position or to particiate in in a Margin closeout.
